...
def arcade():
    ...
    frame = tk.Frame(screenp, width=470, height=350, bg="white")
    frame.place(x=460, y=70)
    heading = tk.Label(frame, text="ARCADE MANAGMENT", fg="#57a1f8", bg="white", font=("Microsoft Yahei UI Light", 23, "bold"))
    heading.place(x=60, y=5)
...
def userdisplay():
    ...
    label = tk.Label(screen, text="CATEGORIES", fg="black", bg="white", font=("Microsoft Yahei UI Light", 40, "bold"))
    label.place(x=770, y=470)
...
def about():
    ...
    label = tk.Label(screen, text="What is Happening", fg="black", bg="white", font=("Microsoft Yahei UI Light", 40, "bold"))
    label.place(x=300, y=470)
...
def contact():
    ...
    label = tk.Label(screen, text="CONTACT INFORMATION", fg="black", bg="white", font=("Microsoft Yahei UI Light", 40, "bold"))
    label.place(x=630, y=470)
...
def brands():
    ...
    label = tk.Label(screen, text="BRANDS", fg="black", bg="white", font=("Microsoft Yahei UI Light", 40, "bold"))
    label.place(x=770, y=470)
