...
def table(sh1, i):
    ...
    tree = ttk.Treeview(table_frame, columns=("product", "price", "quantity"), show="headings")
    ...
    # Packing the Treeview widget into the frame
...
def buttons(screen):
    ...
    Button(frame1, width=6, text="About", border=0, bg="#57a1f8", cursor="hand2", fg="white", font=button_font,command=about).place(x=50, y=0)
    ...
    Button(frame1, width=6, text="Offer", border=0, bg="#57a1f8", cursor="hand2", fg="white", font=button_font,command=offer).place(x=1050, y=0)
    Button(frame1, width=6, text="Brands", border=0, bg="#57a1f8", cursor="hand2", fg="white", font=button_font,command=brands).place(x=1400, y=0)
    Button(frame1, width=6, text="Contact", border=0, bg="#57a1f8", cursor="hand2", fg="white", font=button_font,command=contact).place(x=1700, y=0)
...
def signin2():
    ...
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img8, bg="black", fg="white", border=0, command=signin4).place(x=500, y=600)
...
def signin4():
    ...
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img2 , bg="black", fg="white", border=0, command=shopkeeper1).place(x=300, y=600)
    ...
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img3 , bg="black", fg="white", border=0, command=arcade1).place(x=850, y=600)
...
def signup2():
    ...
    img1 = ImageTk.PhotoImage(resized_image1)# int this add a white frame then black background %%%%%%%%
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img1 , bg="black", fg="white", border=0, command=user11).place(x=420, y=600)
...
def addrecordpark():
    ...
    l = [user1, Modes, no1,s2]
    with open("parkrecord.csv", "a", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(l)
    with open("parkuserdisplaycount.csv","a",newline="") as f2:
...
def exitpark():
    ...
    def on_leave(e):
        name = Model.get()
        if name == "":
            Model.insert(0, "Enter Plate Number")
...
def seerecord():
    ...
    tree = ttk.Treeview(table_frame, columns=("Name", "Plate Number", "Phone Number", "Clock_In", "Clock_Out"), show="headings")
    
    # Define the column headings
    tree.heading("Name", text="Name")
    tree.heading("Plate Number", text="Model")
    tree.heading("Phone Number", text="Phone No.")
    tree.heading("Clock_In", text="Clock In")   
    tree.heading("Clock_Out", text="Clock Out")
    
    # Define column widths
    tree.column("Name", width=150)
    tree.column("Plate Number", width=150)
    ...
    with open("parkrecord.csv", "r") as f:
        csvobj = csv.reader(f)
        for record in csvobj:
            tree.insert("", "end", values=record)
...
#creating check boxes for diff shops :))
    ...
    # Function to check which brand is selected takla fodo sir ka
...
def addrecordnike():
    global product, price, quantity, img
    ...
    def update_inventory():
        ...
        # Validate fields
        if p in ["Product Name", ""] or p1 in ["price", ""] or q in ["quantity", ""]:
        ...
        try:
            with open(sh1, "a", newline="") as f:
                writer = csv.writer(f)
                writer.writerow([p, p1, q])
                print("Data written to file:", [p, p1, q])  # Debug print
...
def arcade():
    ...
    frame = tk.Frame(screenp, width=470, height=350, bg="white")
    frame.place(x=460, y=70)
    heading = tk.Label(frame, text="ARCADE MANAGEMENT", fg="#57a1f8", bg="white", font=("Microsoft Yahei UI Light", 23, "bold"))
    heading.place(x=60, y=5)
...
def enterarcade():
    global user,no,age,ticket  # Declaring them as global variables
...
def exitarcade():
    ...
    def deletearcade():
        ...
        with open("arcaderecord.csv", "r", newline="") as f1, open("test1.csv", "w", newline="") as f2:
            ...
            # Rewriting the original CSV with updated data
            with open("arcaderecord.csv", "w", newline="") as f1, open("test1.csv", "r", newline="") as f2:
                obj1 = csv.writer(f1)
                obj2 = csv.reader(f2)
                for i in obj2:
                    obj1.writerow(i)
...
def seerecordarcade():
    ...
    # Creating the Treeview widget
    tree = ttk.Treeview(table_frame, columns=("Name", "Age", "Phone Number", "Tickets"), show="headings")
    ...
    # Inserting sample data into the table (you can replace this with your actual data)
...
def userdisplay():
    ...
    img2 = ImageTk.PhotoImage(resized_image2)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img2 , bg="black", fg="white", border=0, command=shopdisplayuser).place(x=300, y=600)

    image3 = Image.open("arcade.jpg")
    resized_image3 = image3.resize((200, 200))  # Adjust the width and height as needed
    img3 = ImageTk.PhotoImage(resized_image3)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img3 , bg="black", fg="white", border=0, command=arcadeuserdisplay).place(x=820, y=600)

    image4 = Image.open("parking.jpg")
    resized_image4 = image4.resize((200, 200))  # Adjust the width and height as needed
    img4 = ImageTk.PhotoImage(resized_image4)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img4 , bg="black", fg="white", border=0, command=parkdisplayuser).place(x=1320, y=600)

    label4 = tk.Label(screen, text="SHOPKEEPER", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label4.place(x=310, y=850)

    label5 = tk.Label(screen, text="ARCADE", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label5.place(x=860, y=850)
...
def arcadeuserdisplay():
    ...
    table_frame.place(x=460, y=70)
    #Creating the Treeview widget
    tree = ttk.Treeview(table_frame, columns=("Name", "AGE", "Phone_Number", "Tickets"), show="headings")
...
def shopdisplayuser():
    ...
    label2 = tk.Label(screen, text="NIKE", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label2.place(x=80, y=850)

    label3 = tk.Label(screen, text="GUCCI", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label3.place(x=480, y=850)

    label4 = tk.Label(screen, text="ADIDAS", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label4.place(x=810, y=850)

    label5 = tk.Label(screen, text="PUMA", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label5.place(x=1160, y=850)
...
def nikedisplayuser():
    ...
    global img  # Keeping the image in memory

    table("nikeinventory.csv", "nike.jpg")
...
def GUCCIdisplayuser():
    ...
    table("GUCCIinventory.csv", "GUCCI.jpg")
...
def adidasdisplayuser():
    ...
    table("adidasinventory.csv", "adidas.jpg")
...
def pumadisplayuser():
    ...
    table("pumainventory.csv", "puma.jpg")
...
def about():
    ...
    image1 = Image.open("rakhi.jpg")
    resized_image1 = image1.resize((550, 400))  # Adjust the width and height as needed
    img1 = ImageTk.PhotoImage(resized_image1)

    image2 = Image.open("rakhi2.jpg")
    resized_image2 = image2.resize((1000, 460))  # Adjust the width and height as needed
    img2 = ImageTk.PhotoImage(resized_image2)

    # Display the image in the main window
    tk.Label(screen, image=img, bg="blue").place(x=250, y=5)
    tk.Label(screen, image=img1, bg="blue").place(x=1200, y=600)
    tk.Label(screen, image=img2,bg="black").place(x=10, y=550)
...
def contact():
    ...
    image2 = Image.open("contact.jpg")
    resized_image2 = image2.resize((1000, 460))  # Adjust the width and height as needed
    img2 = ImageTk.PhotoImage(resized_image2)
    
    # Displaying the image in the main window
    tk.Label(screen, image=img, bg="blue").place(x=250, y=5)
    tk.Label(screen, image=img2,bg="black").place(x=400, y=550)
...
def brands():
    ...
    img8 = ImageTk.PhotoImage(resized_image8)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img8, bg="black", fg="white", border=0).place(x=50, y=600)

    image1 = Image.open("GUCCI.jpg")
    resized_image1 = image1.resize((200, 200))  # Adjust the width and height as needed
    img1 = ImageTk.PhotoImage(resized_image1)# int this add a white frame then black background %%%%%%%%
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img1 , bg="white", fg="white", border=0).place(x=420, y=600)

    image2 = Image.open("adidas.jpg")
    resized_image2 = image2.resize((200, 200))  # Adjust the width and height as needed
    img2 = ImageTk.PhotoImage(resized_image2)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img2 , bg="black", fg="white", border=0).place(x=800, y=600)

    image3 = Image.open("puma.jpg")
    resized_image3 = image3.resize((200, 200))  # Adjust the width and height as needed
    img3 = ImageTk.PhotoImage(resized_image3)
    screen.configure(bg="#fff")
    Button(screen, width=200, image=img3 , bg="black", fg="white", border=0).place(x=1120, y=600)
...
def offer():
    ...
    label2 = tk.Label(screen, text="NIKE- UPTO 15% off", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label2.place(x=80, y=850)

    label3 = tk.Label(screen, text="GUCCI- UPTO 10% off", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label3.place(x=480, y=850)

    label4 = tk.Label(screen, text="ADIDAS- UPTO 25% off", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label4.place(x=810, y=850)

    label5 = tk.Label(screen, text="PUMA- UPTO 50% off", fg="black", bg="white", font=("Microsoft Yahei UI Light", 20, "bold"))
    label5.place(x=1160, y=850)
...
img3 = ImageTk.PhotoImage(resized_image4)
root.configure(bg="#fff")
Button(root, width=250, image=img3 ,  fg="white", border=0,command=about).place(x=361, y=890)

image5 = Image.open("mallbrands.jpg")
resized_image5 = image5.resize((220, 80))  # Adjust the width and height as needed
img5 = ImageTk.PhotoImage(resized_image5)
root.configure(bg="#fff")
Button(root, width=220, image=img5 ,  fg="white", border=0,command=brands ).place(x=604.4, y=890)
...
root.configure(bg="#fff")
Button(root, width=220, image=img6 ,  fg="white", border=0,command=contact ).place(x=850, y=875)
